  ...
  <div>
    <div class="list_block">
      <div class="list_title">
        <img src="../assets/img/list_title.png" />演练管理
      </div>
      <div class="list_tabs">
    ...
    <ylgl-add :dialogVisible="dialogVisible" @addclose="closeAdd"></ylgl-add>
    <ylgl-det :disdet="disdet" :ruleForm="one1" @disdet="getData"></ylgl-det>
    <ylgl-sum :dissum="dissum" :ruleForm="one" @dissum="getData"></ylgl-sum>
  </div>
</template>

<script>
import YlglAdd from "../components/YlglAdd.vue";
import YlglDet from "../components/YlglDet.vue";
import YlglSum from "../components/YlglSum.vue";

export default {
  components: { YlglAdd, YlglDet, YlglSum },
  data() {
    return {
      currentpage: 1,
      pagesize: 5,
